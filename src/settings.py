...
SEARCH_DEPTH = 25  # Range: 1-25 | Default 15 | Maximum depth for minimax search algorithm
SEARCH_TIME_LIMIT = 6.0  # Range: 0.1-30.0 | Default 6.0 | Maximum time for iterative deepening search (seconds)
MAX_ITERATIONS = 1200  # Range: 1-1000 | Default 100 | Maximum iterations for search algorithms
...
SEQUENCE_PREFERENCE_MULTIPLIER = 2.5  # Range: 1.0-3.0 | Default 1.5 | Preference multiplier for sequence-building moves over gap-creating moves
